...
fun MetadataSettingsScreen(
    ...
    onSetArtworkOnlyWriteEnabled: (Boolean) -> Unit = {},
    onSetAutoEmbedArtworkAfterMatch: (Boolean) -> Unit = {},
    ...
    LazyColumn(
        ...
        item {
            MetadataEnrichmentSettingsCard(
                ...
                onSetArtworkOnlyWriteEnabled = onSetArtworkOnlyWriteEnabled,
                onSetAutoEmbedArtworkAfterMatch = onSetAutoEmbedArtworkAfterMatch,
                ...
                onPushArtworkToFiles = onPushArtworkToFiles,
